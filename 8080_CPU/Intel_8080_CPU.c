...
void setflags_szap(uint8_t result, uint8_t *FLAGS) {
  //To do
}

void setflags_szapc(uint8_t result, uint8_t *FLAGS) {
  //To do
}
      ...
      case 0x1F:
        ...
        /********************************************************************/
          ...
          /*******************************************************************/
            ...
            case 0x76: printf("%04X   MOV  M,M\n",*PC); Memory[HL] = Memory[HL]; break;
